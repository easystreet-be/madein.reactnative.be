...
const Header = () => {
  ...
  return (
    <div className={style.rootContainer}>
      <PageContainer ignorePadding={true}>
        <div className={style.container}>
          <div className={style.primaryHeader}>
            {/* <Link href="/">
              <Image
                ...
                height={42}
                width={160}
                alt={translations.alt_logo_react_native_belgium}
              />
            </Link> */}
          ...
          <div
            className={`${style.links} ${
              openMobileMenu ? style.openMobileMenu : style.closeMobileMenu
            }`}
          >
            <Link href="/projects">
              <p>Projects</p>
