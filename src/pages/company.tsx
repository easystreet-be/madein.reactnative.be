...
const CompanyDetailPage = () => {
  ...
  return (
    <>
      <Meta
        title={`${company?.name ?? appConfig.website.name} | ${
          ...
          <div className={style.container}>
            <div className={style.infoContainer}>
              <div className={style.titleContainer}>
                ...
                />
                {company.useLogoInsteadOfTextTitle ? null : (
                  <h1>{company.name}</h1>
                )}
              </div>
              <p className={style.description}>{company.description}</p>
              {company.isAgency ? (
                <p className={style.agencyDescription}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                    ...
                    <circle
                      ...
                      stroke-width="16"
                    />
                    <circle fill="white" cx="124" cy="84" r="12" />
                  </svg>
              ...
              <div className={style.phoneProjectListContainer}>
                ...
                <ProjectList
                  title={
                    hasInvolvedProjects
                      ? translations.companies_projects_title
                      : undefined
                  }
